...
int main()
{
	...
	prueba->correrPrueba("EjemploDeUso");
	...
	prueba->correrPrueba("Correccion");
	...
	prueba->correrPrueba("Propias");

	char rutaLectura5[] = "../SalidaDeLasPruebas/SalidasSinProcesar/PruebasPropias.txt";
	char rutaCorreccion5[] = "../PruebasPropias.txt";
	char rutaEscritura5[] = "../SalidaDeLasPruebas/Resultados/PruebasPropiasResultado.txt";
